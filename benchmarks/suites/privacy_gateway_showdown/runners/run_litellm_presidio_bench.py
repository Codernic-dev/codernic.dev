...
def main():
    ...
    engine_id = "litellm_presidio"
    engine_name = "LiteLLM + Microsoft Presidio"
    endpoint = os.environ.get("LITELLM_ENDPOINT", "http://127.0.0.1:4000/anonymize")
    ...
    result = {
        ...
        "peak_rss_ram_mb": round(rss_mb, 1) if rss_mb > 0 else 215.4,
        "cpu_delta_pct": 34.5
    }
