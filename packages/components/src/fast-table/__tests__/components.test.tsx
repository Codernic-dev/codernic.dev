...
describe('SelectionCell', () => {
  ...
  const { rootId, getTestId } = useTestId('anonymous');
render(<SelectionCell data-testid={getTestId('selection-cell')} rowId={1} isSelected={false} onToggle={vi.fn()} />)
  ...
  const { rootId, getTestId } = useTestId('anonymous');
render(<SelectionCell data-testid={getTestId('selection-cell')} rowId={1} isSelected={true} onToggle={vi.fn()} />)
...
const onToggle = vi.fn()
    render(<SelectionCell data-testid={getTestId('selection-cell')} rowId={42} isSelected={false} onToggle={onToggle} />)
...
describe('TableCell', () => {
  ...
  const { rootId, getTestId } = useTestId('anonymous');
render(<TableCell data-testid={getTestId('table-cell')} column={cols[1]!} rowState={makeRowState()} />)
  ...
  const { rootId, getTestId } = useTestId('anonymous');
render(<TableCell data-testid={getTestId('table-cell')} column={cols[0]!} rowState={makeRowState()} />)
...
const onActivate = vi.fn()
    ...
    render(
      <TableCell data-testid={getTestId('table-cell')} column={col} rowState={makeRowState()} onActivate={onActivate} />,
    )
...
describe('HeaderCell', () => {
  ...
  const { rootId, getTestId } = useTestId('anonymous');
render(<HeaderCell data-testid={getTestId('header-cell')} column={cols[0]!} sortState={null} onSort={vi.fn()} />)
  ...
  const { rootId, getTestId } = useTestId('anonymous');
const onSort = vi.fn()
    render(<HeaderCell data-testid={getTestId('header-cell')} column={cols[0]!} sortState={null} onSort={onSort} />)
  ...
  const { rootId, getTestId } = useTestId('anonymous');
render(
      <HeaderCell data-testid={getTestId('header-cell')}
        column={cols[0]!}
...
describe('TableRow', () => {
  ...
  const { rootId, getTestId } = useTestId('anonymous');
render(
      <TableRow data-testid={getTestId('table-row')}
