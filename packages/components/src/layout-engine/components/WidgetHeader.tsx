  ...
  return (
    <div className={`flex shrink-0 items-center justify-between px-2 py-1.5 border-b border-zinc-800/50 bg-[#111113]/90 backdrop-blur ${isMaximized ? 'z-[100]' : 'z-30'}`}>
      ...
      <div className="flex items-center gap-1.5">
        {showHelpIcons && !isEditMode && (
          <button 
            onClick={(e) => { e.stopPropagation(); onHelpClick?.(); }}
            className="w-4 h-4 rounded-full bg-amber-500/10 hover:bg-amber-500/20 text-amber-500 text-[10px] font-bold flex items-center justify-center transition-colors"
