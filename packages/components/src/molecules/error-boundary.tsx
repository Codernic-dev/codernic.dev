...
export function ErrorBoundary(props: Props) {
  const { getTestId } = useTestId('error-boundary');
  
  const rootId = props['data-testid'] ? `${props['data-testid']}-error-boundary` : 'error-boundary';
return <ErrorBoundaryImpl data-testid={getTestId('error-boundary-impl')} {...props} />
}
